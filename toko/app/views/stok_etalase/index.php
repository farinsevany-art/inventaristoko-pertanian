...
<div class="container mt-4">
    ...
    <?php else : ?>
        <table class="table table-bordered">
            <thead>
                <tr><th>#</th><th>ID Stok Etalase</th><th>ID Barang</th><th>Nama Barang</th><th>Jenis Barang</th><th>Kadaluarsa</th><th>Jumlah</th><?php if (!empty($_SESSION['admin_logged_in'])): ?>
                        <th>Aksi</th>
                    <?php endif; ?></tr>
            </thead>
            <tbody>
